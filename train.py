...
# ── Training samples per class (used for loss weighting & sampler) ────────────
...
def get_weighted_sampler(dataset):
    """WeightedRandomSampler so each batch is roughly class-balanced."""
...
def main(args):
    ...
    criterion = nn.CrossEntropyLoss(weight=get_loss_weights(device))
